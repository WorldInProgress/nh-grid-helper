...
class NHGridHelper:
    ...
    def check_edge_code_along_grid(self, edge_id: int, grid: NHGrid) -> int:
    ...
    def get_grid_by_id(self, id: int) -> NHGrid:
    ...
    def get_grids_adjacent_to_edge(self, edge: NHGridEdge) -> list[NHGrid]:
